...
//
//// 生产服务器地址
static NSString * const kServerUrl  = @"http://api.wangwangwhb.com/api/";
// 测试服务器地址
...
// ****   融云
// ***/
static NSString * const kRongYunKey = @"4z3hlwrv4goft";
 ...
 ****   微信 2019.03.02
 ***/
static NSString * const WXKey = @"wx7dee96d9b15804bd";//@"wxb9a25b32bcf8449c";
...
// 保存下载页 URL
static NSString * const kDownloadPageURL = @"https://www.wangwanghb.com/appdown/IOS/index.html?code=";
static NSString * const kJSPatchURL = @"https://www.wangwangwhb.com";
