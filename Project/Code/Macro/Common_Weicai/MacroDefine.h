...
//获取红包信息
#define Line_PacketInfo Line(@"Redpacket/redpacketLogs") //Redpacket/redpacketCheck
//获取红包状态
...
//定位返回通知
#define notif_localCoordinateBack @"localCoordinateBack"
#define notif_localCityBack @"localCityBack"

/**
 ***    加密KEY
 **/
static NSString* const KEY_AES = @"1234567887654321";
static NSString* const KEY_AES_IV = @"1234567887654321";
static NSString* const KEY_AUTH = @"Basic cGlnOnBpZw==";
