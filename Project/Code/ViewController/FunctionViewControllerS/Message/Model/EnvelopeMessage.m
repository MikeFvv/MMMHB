...
- (instancetype)initWithObj:(id)obj{
    ...
    if (self) {
        ...
        [extra CDSetNOTNULLObject:[obj objectForKey:@"list"] forKey:@"list"];
        [extra CDSetNOTNULLObject:APP_MODEL.user.userId forKey:@"id"];
        [extra CDSetNOTNULLObject:[NSString cdImageLink:APP_MODEL.user.userAvatar] forKey:@"headImg"];
        [extra CDSetNOTNULLObject:APP_MODEL.user.userNick forKey:@"username"];
