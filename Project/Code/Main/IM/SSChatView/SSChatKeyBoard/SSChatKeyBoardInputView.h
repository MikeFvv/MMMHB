...
//#define SSChatTextWidth      FYSCREEN_Width - (3*SSChatBtnSize + 5* SSChatBtnDistence)   //输入框的宽度
#define SSChatTextWidth      FYSCREEN_Width - (2*SSChatBtnSize + 4* SSChatBtnDistence)   //输入框的宽度
