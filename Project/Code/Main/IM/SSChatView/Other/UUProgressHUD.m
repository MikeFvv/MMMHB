...
- (void)show
{
	...
	self.titleLabel.center = CGPointMake(FYSCREEN_Width/2,FYSCREEN_Height/2 - 30);
	self.titleLabel.text = @"倒计时";
	
	self.subTitleLabel.center = CGPointMake(FYSCREEN_Width/2,FYSCREEN_Height/2 + 30);
	self.subTitleLabel.text = @"向上滑动取消";
	
	self.centerLabel.center = CGPointMake(FYSCREEN_Width/2,FYSCREEN_Height/2);
