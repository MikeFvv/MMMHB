...
#define WXUserInfoAPI @"https://api.weixin.qq.com/sns/userinfo"
...
+ (BOOL) handleOpenURL:(NSURL *)url{
    return [WXApi handleOpenURL:url delegate:[WXManage shareInstance]];
}
